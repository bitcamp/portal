...
<template>
  <b-row>
    ...
    <b-col md="10">
      <br />
      <h1 style="text-align: left">Register for Bitcamp 2026 - Volunteer</h1>

      <p style="font-size: 0.9rem; opacity: 95%">
        To register as a volunteer, please fill out the form below!
      </p>
      <p style="font-size: 0.9rem; opacity: 95%">
        As a volunteer, you will assist organizers with various tasks such as setting up, serving
        food, etc. We greatly appreciate your time and effort!
      </p>
      <p style="font-size: 0.9rem; opacity: 95%">
      ...
      <p style="font-size: 0.9rem; opacity: 95%">
        Feel free to reach out to <a href="mailto:personnel@bit.camp">personnel@bit.camp</a> with
        any additional questions you may have about volunteering, or learn more at
