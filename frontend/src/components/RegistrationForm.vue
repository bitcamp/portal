    ...
    <b-row>
        ...
        <b-col md="10">
            ...
            >
                ...
                <p class="info">
                    Once you register, you'll receive more info about Bitcamp
                    2022 at the email you provide.
                </p>
                <b-form-row>
                    <b-form-group
                        id="input-group-1"
                ...
                <p class="info">
                    Let us know, and we'll pass your info on to our partners and
                    sponsors!
                </p>
                ...
                <b-form-row>
                    ...
                    >
                        ...
                        <b-form-invalid-feedback :state="valid_resume">
                            We couldn't upload your resume. Try again later, or
                            check that you entered your name first!
                        </b-form-invalid-feedback>
                    </b-form-group>
                </b-form-row>
                ...
                <p class="info">
                    We plan on handing out all swag in-person at the event, but
                    in case we need to ship swag to you instead, this is where
                    we'll send it to. Please note that we can only ship to the
                    USA.
                </p>
                <b-form-group>
                    <b-form-row>
                    ...
                    <b-form-invalid-feedback
                        ...
                        style="margin: 0"
                    >
                        Please provide a valid shipping address to apply for the
                        hardware track.
                    </b-form-invalid-feedback>
                </b-form-group>
                ...
                <p class="info">
                    This year, you’ll once again be put into one of three teams
                    based on your personality and interests. By winning unique
                    challenges and attending workshops and mini-events, you and
                    your fellow hackers will rack up points for your team. At
                    the end of the event, members of the winning team will
                    receive limited edition Bitcamp apparel. So what are you
                    waiting for? Take the survey and find your team!
                </p>
                <b-form-group
                ...
                >
                    ...
                    >
                        <b-form-radio value="r"
                            >I'm up on the stage!</b-form-radio
                        >
                        <b-form-radio value="g"
                            >Takes some convincing</b-form-radio
                        >
                        <b-form-radio value="b">Never in my life</b-form-radio>
                        <b-form-radio value="g1"
                            >Karaoke? What's that?</b-form-radio
                        >
                    </b-form-radio-group>
                ...
                >
                    ...
                    >
                        ...
                        <b-form-radio value="b1"
                            >I'll stay in for the night</b-form-radio
                        >
                    </b-form-radio-group>
                ...
                >
                    ...
                    >
                        ...
                        <b-form-radio value="r1"
                            >Wait, I had class today?</b-form-radio
                        >
                    </b-form-radio-group>
                ...
                >
                    ...
                    >
                        ...
                        <b-form-radio value="g"
                            >Different every time</b-form-radio
                        >
                        <b-form-radio value="r1"
                            >Pineapple. Pizza.</b-form-radio
                        >
                    </b-form-radio-group>
                ...
                >
                    ...
                    >
                        ...
                        <b-form-radio value="g1"
                            >First hackathon, I’ll find out!</b-form-radio
                        >
                    </b-form-radio-group>
                ...
                <p class="info">
                    We've got unisex T-shirts in XS-XL sizes! Choose whichever
                    size you like, and your very own Bitcamp 2022 shirt will be
                    given to you once you arrive at UMD.
                </p>
                ...
                <p class="info">
                    We'd like to get to know you a little better! Help us learn
                    more about you and make Bitcamp even more amazing by
                ...
                <b-form-row>
                    ...
                    >
                        ...
                        <b-form-invalid-feedback :state="valid_question1">
                            Please tell us why you are interested in attending
                            Bitcamp
                        </b-form-invalid-feedback>
                    </b-form-group>
                </b-form-row>
                ...
                <b-form-row>
                    ...
                    >
                        ...
                        <b-form-invalid-feedback :state="valid_question2">
                            Please tell us what you plan on doing/building at
                            Bitcamp
                        </b-form-invalid-feedback>
                    </b-form-group>
                </b-form-row>
                ...
                >
                    ...
                    emails, which contain free credit and opportunities from
                    their partners.
                </b-form-checkbox>
...
export default {
    ...
    data() {
        return {
            form: {
                email:
                    this.$route.query.redo != null
                        ? this.$route.query.redo
                        : '',
                phone: '',
                MLH_emails: false,
                MLH_conduct: false,
    ...
    methods: {
        ...
        fillInAddress(place) {
            ...
            for (const component of place.address_components) {
                ...
                switch (componentType) {
                    ...
                    case 'locality':
                        this.form.city = document.getElementById(
                            'input-city'
                        ).value = component.long_name;
                        break;

                    case 'administrative_area_level_1': {
                        this.form.state = document.getElementById(
                            'input-state'
                        ).value = component.short_name;
                        break;
                    }
                    case 'country':
                        this.form.country = document.getElementById(
                            'input-country'
                        ).value = component.short_name;
                        break;
                }
            }
            this.form.address1 = document.getElementById('input-5').value =
                address1;
            this.form.zip = document.getElementById('input-zip').value =
                postcode;
        ...
        formCheck() {
            ...
            if (this.form.hack_count.length === 0 || parseInt(this.form.hack_count) < 0 ) {
                console.log(this.form.hack_count)
