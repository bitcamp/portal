...
let main_template = {
  Template: {
    ...
    SubjectPart: "RSVP for Bitcamp 2022!",
    TextPart: `Hey {{name}}, thanks for registering for Bitcamp 2022! 
    \n\nWe're excited to have you join us at Bitcamp 2022!
    \n\nBefore you come, we want to make sure that we're ready to make Bytecamp the best Bitcamp ever!
    \n\nPlease fill out this RSVP form {{link}} so that we have a better idea of how many people are coming to Bitcamp 2022.
...
let minor_template = {
  Template: {
    ...
    SubjectPart: "Action Needed, Complete your Minor Application for Bitcamp 2022!",
    TextPart: `Hey {{name}}, thanks for registering for Bitcamp 2022! 
