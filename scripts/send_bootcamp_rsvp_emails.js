...
let template = fs.readFileSync(
  './templates/bootcamp_rsvp_template.html',
  'utf8'
);
// template = template.replace('{header text}',);
let main_template = {
  Template: {
    TemplateName: 'BootcampRSVPTemplate',
    SubjectPart: 'Reminder: Bitcamp Bootcamp + Sponsor Fair happening TODAY!',
    TextPart: `Hey {{name}}
    \n\nThank you for RSVP-ing to Bitcamp Bootcamp! We're excited to welcome you and other
    \nBitcampers to this fun-filled community event! As a reminder, this event will be held
    \non Thursday, March 30th from 8-9:30pm at ESJ 2204.
    \n\nJoin us to learn more about bitcamp, find potential teammates, eat some Maryland
    \nDairy, and engage in exclusive networking with sponsors.
    \n\nHave friends who are interested in coming? Have them fill out the RSVP form at this
    \nlink: https://bit.camp/bootcamp-rsvp.
...
const fileNameOriginal = `./bootcamp-rsvp-users-original.csv`;
const fileName = `./bootcamp-rsvp-users.csv`;
